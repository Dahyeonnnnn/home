...
public class TestMapperTest {
	...
	@Test
	public void 파라미터_상수값_전달하기() {
		String result = mapper.paramTest3("DEPT_NO");
		log.info(result);
	}
	@Test
	...
	@Test
	public void if문_테스트() {
		//ArrayList<HashMap<String, String>> list = mapper.ifTest(0);
		ArrayList<HashMap<String, String>> list = mapper.ifTest(1001);
		log.info(list.toString());
	}
	@Test
	public void choose문_테스트() {
...
//		ArrayList<HashMap<String, String>> list = mapper.chooseTest(1001,null);
		ArrayList<HashMap<String, String>> list = mapper.chooseTest(1001,"정소화");
		log.info(list.toString());
	}
}
